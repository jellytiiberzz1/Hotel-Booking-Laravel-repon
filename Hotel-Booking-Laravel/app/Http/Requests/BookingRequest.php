...
class BookingRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'date_from.required' => 'Ngày nhận phòng không được bỏ trống',
            'date_from.date' => 'Ngày nhận phòng phải là ngày',
            'date_to.required' => 'Ngày trả phòng không được bỏ trống',
            'date_to.date' => 'Ngày trả phòng phải là ngày',
            'date_to.after' => 'Ngày trả phòng phải lớn hơn ngày nhận phòng',
        ];
    }
}
