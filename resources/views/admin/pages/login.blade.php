...
<head>
    ...
    <link href="libraries/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
    <!-- Custom styles for this template-->
    <link href="libraries/css/sb-admin-2.min.css" rel="stylesheet">
        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block "><img src="{{asset('libraries/img/logo.png')}}" style="width: 464.98px;height: 365px" alt=""></div>
                        <div class="col-lg-6">
                            <div class="p-5">
...
<script src="libraries/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- Core plugin JavaScript-->
<script src="libraries/vendor/jquery-easing/jquery.easing.min.js"></script>
